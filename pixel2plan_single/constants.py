...
# Number of features for graph node encoding (defined by environment)
N_FEATURES_STATE = 4

# Network structures
actor_structure = NetworkStructure(n_features=N_FEATURES_STATE, n_layers=3, embed_dim=64, n_heads=4,
                                   n_hidden_readout=[], dim_single_pred=3)
critic_structure = NetworkStructure(n_features=N_FEATURES_STATE + actor_structure.dim_single_pred, n_layers=3,
                                    embed_dim=64, n_heads=4, n_hidden_readout=[], dim_single_pred=1)
